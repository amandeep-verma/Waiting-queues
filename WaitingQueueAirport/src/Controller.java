...
public class Controller extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int checkin  = Integer.parseInt(req.getParameter("duration"));
		int coach_Arrrate = Integer.parseInt(req.getParameter("CoachArrivalRate"));
		int coach_Servrate = Integer.parseInt(req.getParameter("CoachServiceRate"));
		int first_Arrrate = Integer.parseInt(req.getParameter("FirstArrivalRate"));
		int first_Servrate = Integer.parseInt(req.getParameter("FirstServiceRate"));
		...
		out.println("\n************************************************************************************");
		out.println("The duration of the simulation is "+i+ " minutes");
		out.println("Max length of Coach queue is "+maxlength1);
		out.println("Max length of First class queue is "+maxlength2);
		out.println("The max wait time for Coach queue is "+maxWaitTime1+" minutes");
		out.println("The max wait time for First class queue is "+maxWaitTime2+" minutes");
		out.printf("The average wait time for Coach queue is %.2f min\n",avgwaitTime1);
		out.printf("The average wait time for First class queue is %.2f min\n",avgwaitTime2);
		out.println("The percentage of time for which coach service station c1 was busy "+(cc1*100/(i))+"%");
		out.println("The percentage of time for which coach service station c2 was busy "+(cc2*100/(i))+"%");
		out.println("The percentage of time for which coach service station c3 was busy "+(cc3*100/(i))+"%");
		out.println("The percentage of time for which first class service station f1 was busy "+(cf1*100/(i))+"%");
		out.println("The percentage of time for which first class service station f2 was busy "+(cf2*100/(i))+"%");
		out.println("************************************************************************************");
